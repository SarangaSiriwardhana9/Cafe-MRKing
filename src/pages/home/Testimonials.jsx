        ...
        <div className='section-container'>
            <div className='flex flex-col md:flex-row items-center  justify-between gap-12 '>
                ...
                <div className='md:w-1/2'>
                    <img src="./testimonials.png" alt="testimonials" className="w-full" />
                </div>
                ...
                <div className='md:w-1/2'>
                    <div className='text-left md:w-4/s'>
                        ...
                        <div className=' ml-2'>
                        <blockquote className='text-gray-600 my-5 leading-[30px] '>
                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, voluptatum. Quod, voluptatum. Quod, voluptatum.
                        </blockquote>
